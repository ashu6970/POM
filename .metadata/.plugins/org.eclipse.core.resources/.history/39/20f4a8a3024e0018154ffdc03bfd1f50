...
public class Manager extends Base_Test{
	...
	{
				waitForElement(btn_order);
				javaScriptClick(btn_order);			
	}
	...
	public void doClickOnStartTranslation() throws Exception
	{
